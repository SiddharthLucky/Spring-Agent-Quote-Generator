...
* The original package name 'com.aiagents.quote-generator' is invalid and this project uses 'com.aiagents.quote_generator' instead.
...
```
$ docker run --rm quote-generator:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/quote-generator
```
